...
Console.WriteLine("My name is Nick Narcisse!");
...
string[] names2 = new[] { "Timmy", "Mathew", "Jenny", "Lisa" };
...
{
  { "Omega", "Zeta", "Sigma", "Epsilon" },
  { "Nick", "Max", "Zack", "Carl" },
  { "Snake", "Alligator", "Lion", "Hyena" }
};
...
grid2[0, 0] = "Omega"; // assign string values
// and so on
grid2[2, 3] = "Hyena";

string[][] jagged = new[] // array of string arrays
{
  new[] { "Omega", "Zeta", "Sigma" },
  new[] { "Nick", "Max", "Zack", "Carl" },
  new[] { "Snake", "Alligator" }
};
